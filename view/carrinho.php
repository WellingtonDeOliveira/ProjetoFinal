            ...
            <div class="row">
              <tr>
                ...
                <th class="col-4">
                  <div class="row">
                    <p class="descri"></p>
                    <a href="../script/carrinhoLogica.php?decrementar=<?php echo $value['id']; ?>" class="col-3 btnAd">
                      <img src="../assets/btnMe.png" class="btnMe" alt="Menos">
                    </a>
                    <p class="col-4 meio"><?php echo $value['quantidade']; ?></p>
                    <a href="../script/carrinhoLogica.php?adicionar=<?php echo $value['id']; ?>" class="col-4 btnAd">
